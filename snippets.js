...
if(res) { verses = await res.json();
        } else { alert('This file has not been retrieved from the server yet. To access this file you must connect to the internet, so it can be fetched. Once it has been fetched from the internet, it will then be available offline for future use.'); };
